...
const contractAddress = "0xE34271aB0Ae4e9938bd99739626eDdf549C3b0E7";
...
export const allowPaidMinting = async (data) => {
  try {
    ...
    return {
      type: "success",
      message: "allowPaidMinting settings set successfully",
    };
  } catch (error) {
    return { type: "error", message: error.reason };
  }
...
export const whitelistMinting = async (data) => {
  try {
    ...
    return {
      type: "success",
      message: "allowWhitelistMinting settings set successfully",
    };
  } catch (error) {
    return { type: "error", message: error.reason };
  }
...
export const deployContract = async ({ arg1, arg2, arg3 }) => {
  if (signer) {
    ...
    try {
      const contract = await contractFactory.deploy(arg1, arg2, arg3);
      await contract.deployed();

      return {
        type: "success",
        message: `Contract deployed at address: ${contract.address}`,
      };
    } catch (error) {
      return { type: "error", message: error.reason };
    }
...
export const specialMinting = async (data) => {
  try {
    ...
    return {
      type: "success",
      message: "specialMinting settings set successfully",
    };
  } catch (error) {
    return { type: "error", message: error.reason };
  }
...
export const setCurrentNftPriceFunc = async (data) => {
  try {
    ...
    return {
      type: "success",
      message: "Current Nft price update successfully",
    };
  } catch (error) {
    return { type: "error", message: error.reason };
  }
...
export const handleMintNft = async ({ tokenId, address, proof }) => {
  // console.log(address);
  // console.log(proof);
